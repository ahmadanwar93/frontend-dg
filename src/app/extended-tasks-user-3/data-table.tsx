...
export function DataTable<TData, TValue>({
    ...
    const deleteProduct = async function (id: number) {
        try {
            let api = `${BACKEND_API}/api/3/delete-inventory/${id}`;
                    ...
                    <DialogContent className="sm:max-w-[425px]">
                        ...
                        <DialogFooter>
                            <Button type="submit" onClick={async () => {
                                await fetch(`${BACKEND_API}/api/3/add-inventory`, {
                                    method: "POST",
                                    headers: {
                                            ...
                                            <>
                                                <Dialog open={isupdateFormOpen} onOpenChange={setUpdateFormOpen}>
                                                    ...
                                                    <DialogContent className="sm:max-w-[425px]">
                                                        ...
                                                        <DialogFooter>
                                                            <Button type="submit" onClick={async () => {
                                                                await fetch(`${BACKEND_API}/api/3/update-inventory/${updateFormData.id}`, {
                                                                    method: "PUT",
                                                                    headers: {
                                                                        "Access-Control-Allow-Origin": "*",
                                                                        "Content-Type": "application/json",
